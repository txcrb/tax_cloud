...
You can obtain all tax codes as well as lookup a tax code by ID.
    ...
    TaxCloud::TaxCodes.all # a hash table of all codes
    tax_code = TaxCloud::TaxCodes[TaxCloud::TaxCodes::HANDLING_FEE]
    tax_code.ticid # 11000 or TaxCloud::TaxCodes::HANDLING_FEE
    tax_code.description # "Handling, crating, packing, preparation for mailing or delivery, and similar charges"
